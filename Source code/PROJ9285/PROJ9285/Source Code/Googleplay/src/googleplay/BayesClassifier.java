...
public class BayesClassifier<T, K> extends Classifier<T, K> {
    ...
    //private SortedSet<Classification<T, K>> categoryProbabilities(
        ...
        /*
         * Sort the set according to the possibilities. Because we 
...
//    }
//
//    private Iterable<K> getCategories() {
